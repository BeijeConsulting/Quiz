...
CREATE TABLE `domanda` (
  ...
  `spiegazione` varchar(1000) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `quiz` (
  ...
  `domande` varchar(1000) DEFAULT NULL,
  `risposte_utente` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `risposta` (
  ...
  `corretto` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-10-19 14:55:28
